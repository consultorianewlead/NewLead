          ...
          <div>
            ...
            <Form ref={form} onSubmit={sendEmail} >
              ...
              <div style={{ display: "grid", justifyContent: "center" }}>
                <Text>Name</Text>
                <Input name="name" style={{ width: width / 5, height: height / 16 }} placeholder="Ex: João" />

                <Text>WhatsApp</Text>
                <Input name="whatsapp" style={{ width: width / 5, height: height / 16 }} placeholder="Ex: (12) 3 45678910" />

                <Text>E-mail</Text>
                <Input name="email" style={{ width: width / 5, height: height / 16 }} placeholder="Ex: joaopedro@gmail.com" />
              </div>
              ...
              <div style={{ display: "flex", justifyContent: "center"}}>
                <Button style={{ width: width / 5, height: height / 16 }} type="submit" onClick={sendEmail} >Entrar em contato agora</Button>
              </div>
